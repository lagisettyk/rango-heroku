...
def display_matplotlib(request):
	...
	return render(request, 'rango/Simple-Matplotlib.html', context_dict)

def display_hichart(request):
	print ">>>>> entered display_hichart"
	context_dict = {'hichart': "Simple-HiChart-Example"}
	return render(request, 'rango/histock_example.html', context_dict)



### Views examples related to Integrating Graphics charts into DJango framework...
def simple(request):
	import random
	import datetime
